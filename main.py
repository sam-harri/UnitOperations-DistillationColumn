...
if(__name__ == '__main__'):
    ...
    while(True):
        ...
        Water_Flow = ((Feed + RecycleFeed)*(oatm_CP)*(oatm_PreTemperature-oatm_WantedTemperature))/((Water_HeatCapacity)*(oatm_WantedTemperature-Water_Temperature)) * 18.02 #L/h
    ...
    ax2.axis('off')
    #inlet
    plt.figtext(0.07, 0.52, str(Feed) + " [kmol/h]", fontsize = 'small')
    plt.figtext(0.07, 0.49, str(Feed_zTHF) + " [molTHF/mol]", fontsize = 'small')
    plt.figtext(0.07, 0.46, str(Feed_zMEOH) + " [molMEOH/mol]", fontsize = 'small')
    ...
    #col1 distills
    plt.figtext(0.53, 0.46, str(oatm_dFeed)[0:5] +"[kmol/h]", fontsize = 'small')
    plt.figtext(0.53, 0.43, str(oatm_dComposition[0])[0:6] + "[molTHF/mol]", fontsize = 'small')
    plt.figtext(0.53, 0.40, str(1-oatm_dComposition[0])[0:6] + "[molMEOH/mol]", fontsize = 'small')
    
    #col2 bottoms
    plt.figtext(0.75, 0.1, str(tatm_bFeed)[0:5] +"[kmol/h]", fontsize = 'small')
    plt.figtext(0.75, 0.07, str(tatm_bComposition[0])[0:6] + "[molTHF/mol]", fontsize = 'small')
    plt.figtext(0.75, 0.04, str(1-tatm_bComposition[0])[0:6] + "[molMEOH/mol]", fontsize = 'small')
    ...
    plt.figtext(0.29, 0.52, str(oatm_EntryDuty)[:str(oatm_EntryDuty).index('.')] +" [kW]", fontsize = 'small') #HeatExchanger Duty
    plt.figtext(0.28, 0.55, str(Water_Flow)[:str(Water_Flow).index('.')] +" [Lwater/h]", fontsize = 'small') #HeatExchanger Duty
    
    imgplot = plt.imshow(img)
    
    fig3, ax3 = plt.subplots(1,1, figsize=(16.5, 13))
